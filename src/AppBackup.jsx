    ...
    <div className="master">
      ...
      <section className="section2">
        ...
        <div className="infoSection2">
          ...
          <p>
            Soy <strong>Marco Martínez</strong>, abogado especializado en
            derecho civil con más de 10 años de experiencia. Me esfuerzo por
            brindar soluciones legales confiables, éticas y personalizadas a
          ...
          <p>
            Mi objetivo es construir relaciones duraderas basadas en la
            confianza, la responsabilidad y la transparencia.
          </p>
        </div>
      </section>
      {/*------------------Third Section---------------------*/}
